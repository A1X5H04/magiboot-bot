/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 62986a5530fc36be6a23b115178190dd)
// Runtime types generated with workerd@1.20250913.0 2025-08-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		JOB_QUEUE: KVNamespace;
		ENVIRONMENT: "development";
		BOT_INFO: "{\"id\":7998712945,\"is_bot\":true,\"first_name\":\"Bootanimation Bot\",\"username\":\"MagibootBot\",\"can_join_groups\":true,\"can_read_all_group_messages\":false,\"supports_inline_queries\":false,\"can_connect_to_business\":false,\"has_main_web_app\":false}";
		GITHUB_SLUG: "a1x5h04/magiboot-bot";
		BOT_TOKEN: string;
		GITHUB_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BOT_INFO" | "GITHUB_SLUG" | "BOT_TOKEN" | "GITHUB_TOKEN">> {}
}
